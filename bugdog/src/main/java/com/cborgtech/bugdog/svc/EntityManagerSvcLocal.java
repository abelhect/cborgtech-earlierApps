...
package com.cborgtech.bugdog.svc;
...
public class EntityManagerSvcLocal implements EntityManagerSvc {
	...
	@PersistenceContext(unitName = "bugdogmain")  
    protected EntityManager main;
	
	@PersistenceContext(unitName = "bugdog1")
	...
	public EntityManager getInstance(){
		...
		if (cdomain.getAPPDomain().equals("bugdog1")){
			return client1;
		} else {
			return client1;
		}
