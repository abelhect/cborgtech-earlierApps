...
package com.cborgtech.gatedog.svc;
...
@Alternative
@Priority(Interceptor.Priority.APPLICATION+14)
public class EntityManagerSvcLocal implements EntityManagerSvc {
	
	@PersistenceContext(unitName = "gatedogmain")  
    protected EntityManager main;
	
	@PersistenceContext(unitName = "gatedog1")
	...
	public EntityManager getInstance(){
		...
		if (cdomain.getAPPDomain().equals("gatedog1")){
			return client1;
		} else {
			return client1;
		}
