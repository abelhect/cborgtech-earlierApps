...
memberLayout.prototype = Object.create(toastHubBase.prototype);
memberLayout.prototype.constructor = memberLayout;

toastHub.registerLayout("memberLayout",new memberLayout());

function memberLayout(instanceName){
	toastHubBase.call(this,instanceName,this);
	this.TAG = "memberLayout::";
	...
	this.navRenderer = function(params){
		...
		params.menuNames = new Array("TOASTHUB_MEMBER_MENU_RIGHT");
	...
	this.navRendererDraw = function(JSONData) {
		...
		var menuRight = JSONData.params.MENUS.TOASTHUB_MEMBER_MENU_RIGHT;
