...
function toastHubBase(instanceName,parent){
	...
	this.callService = function(params){
		...
		this.params = params;
    	var callUrl = toastHub.restUrl.concat(this.ajaxFunc).concat("/callService");
...
function toastHubUtils(){
	...
	this.adjustStyle = function(params) {
		...
		if (document.getElementById("default-stylesheet") == null){
			...
			cssNode.href = "/".concat(contextPath).concat("/").concat(cssDir).concat('toastHub/site.css');
		...
		if (document.getElementById("base-stylesheet") == null){
			...
			cssNode.href = "/".concat(contextPath).concat("/").concat(cssDir).concat(cssname).concat('/site.css');
			cssNode.media = 'screen';
			headID.appendChild(cssNode);
    	}
	    if (width < 471 || (navigator.userAgent.indexOf('iPhone') != -1) || (navigator.userAgent.indexOf('iPod') != -1)) {
	    	if (document.getElementById("page-stylesheet") == null){
				...
				cssNode.href = "/".concat(contextPath).concat("/").concat(cssDir).concat(cssname).concat('/small.css');
				cssNode.media = 'screen';
				headID.appendChild(cssNode);
	    	} else {
	    		jQuery("#page-stylesheet").attr("href", "/".concat(contextPath).concat("/").concat(cssDir).concat(cssname).concat("/small.css"));
	    	}
	    	...
	    	if (document.getElementById("page-stylesheet") == null){
				...
				cssNode.rel = 'stylesheet';
				cssNode.id = 'page-stylesheet';
				cssNode.href = "/".concat(contextPath).concat("/").concat(cssDir).concat(cssname).concat('/medium.css');
				cssNode.media = 'screen';
				headID.appendChild(cssNode);
	    	} else {
	    		jQuery("#page-stylesheet").attr("href", "/".concat(contextPath).concat("/").concat(cssDir).concat(cssname).concat("/medium.css"));
	    	}
	    	...
	    	if (document.getElementById("page-stylesheet") == null){
				...
				cssNode.rel = 'stylesheet';
				cssNode.id = 'page-stylesheet';
				cssNode.href = "/".concat(contextPath).concat("/").concat(cssDir).concat(cssname).concat('/full.css');
				cssNode.media = 'screen';
				headID.appendChild(cssNode);
	    	} else {
	    		jQuery("#page-stylesheet").attr("href", "/".concat(contextPath).concat("/").concat(cssDir).concat(cssname).concat("/full.css"));
	    	}
	    	jQuery("#jquery-stylesheet").attr("href", "http://code.jquery.com/ui/1.8.17/themes/ui-lightness/jquery-ui.css");
