...
/////////////////////////////////// init Top Nav ////////////////////////
	...
	this.processTopMenuOld = function(JSONData){
		...
		if (JSONData.username == null){
			...
			loginHref.href = "/"+toastHub.contextPath+"/login/login.html";
		...
		for (var i in menuLeft) {
			if (menuLeft.hasOwnProperty(i)){
				...
				navLeftMenuHref.href = "/"+toastHub.contextPath+menuLeft[i].values[0].href;
		...
		for (var i in menuRight){
			if (menuRight.hasOwnProperty(i)){
				...
				navRightMenuHref.href = "/"+toastHub.contextPath+menuRight[i].values[0].href;
	...
	this.addSubMenu = function(container,children){
		for (var i in children){
			if (children.hasOwnProperty(i)){
				...
				subMenuHref.href = "/"+toastHub.contextPath+children[i].values[0].href;
