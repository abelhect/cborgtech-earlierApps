...
function toastHubUserManager(instanceName,parent){
	...
	this.redirectToLogin = function(){
		...
		if (this.username != null){
			window.location = "http://".concat(location.hostname).concat(":8080/").concat(toastHub.contextPath).concat("/login/login.html?username=").concat(this.username);
		} else {
			window.location = "http://".concat(location.hostname).concat(":8080/").concat(toastHub.contextPath).concat("/login/login.html");
		}
	}; //redirectToLogin
	...
	this.redirectToDashboard = function(){
		...
		window.location = "/".concat(toastHub.contextPath).concat("/member/index.html");
	}; //redirectToDashboard
