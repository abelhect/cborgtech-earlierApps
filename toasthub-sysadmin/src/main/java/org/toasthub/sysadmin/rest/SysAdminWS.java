...
package org.toasthub.sysadmin.rest;
...
public class SysAdminWS {
	...
	public String callService(RestRequest request) {
		...
		ServiceProcessor x = serviceLocator.getService("SYS_ADMIN",(String) request.getParams().get(BaseEntity.SERVICE),
