...
import org.toasthub.admin.system.dao.ClientDomainAdminDaoIface;
import org.toasthub.admin.system.dao.ClientDomainAdminDaoQual;
...
import org.toasthub.core.system.svc.ClientDomainSvc;

@ClientDomainAdminSvcQual
@RequestScoped
public class ClientDomainAdminSvc extends ClientDomainSvc implements ServiceProcessor, ClientDomainAdminSvcIface {

	@Inject @ClientDomainAdminDaoQual ClientDomainAdminDaoIface clientDomainDao;
	...
	public void delete(RestRequest request, RestResponse response) {
		try {
			clientDomainDao.delete(request, response);
	...
	public void save(RestRequest request, RestResponse response) {
		try {
			...
			if (request.containsParam(BaseEntity.ITEMID) && !request.getParam(BaseEntity.ITEMID).equals("")) {
				...
				request.addParam(BaseEntity.ITEM, new ClientDomain());
			}
			...
			// save
			clientDomainDao.save(request, response);
