...
import org.toasthub.admin.dao.MenuAdminDaoIface;
import org.toasthub.admin.dao.MenuAdminDaoQual;
...
import org.toasthub.core.general.svc.MenuSvc;
import org.toasthub.core.general.svc.UtilSvc;

@MenuAdminSvcQual
@RequestScoped
public class MenuAdminSvc extends MenuSvc implements ServiceProcessor, MenuAdminSvcIface {

	@Inject @MenuAdminDaoQual MenuAdminDaoIface menuDao;
	...
	public void delete(RestRequest request, RestResponse response) {
		try {
			menuDao.delete(request, response);
			// reset cache
			appCacheMenu.clearMenuCache();
