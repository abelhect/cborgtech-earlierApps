...
adminIndex.prototype = Object.create(toastHubBase.prototype);
adminIndex.prototype.constructor = adminIndex;

toastHub.registerController("index",new adminIndex());

function adminIndex(instanceName){
	toastHubBase.call(this,instanceName,this);
	this.TAG = "index::adminIndex::";
	this.ajaxFunc = "admin";
	this.service = "ADMIN_SVC";
	this.pageMetaName = "ADMIN_INDEX";
	var self = this;
	...
	this.headerRenderer = function(params) {
		...
		introLeadIn.innerHTML = "Welcome to admin area";
