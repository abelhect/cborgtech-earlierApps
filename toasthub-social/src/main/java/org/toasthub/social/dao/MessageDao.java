...
public class MessageDao {
	...
	public void itemCount(RestRequest request, RestResponse response) throws Exception {
		Query query = null;
		String HQLQuery = "SELECT count(*) FROM Message AS m WHERE m.owner.id <> :uid";
	...
	public void items(RestRequest request, RestResponse response) throws Exception {
		...
		String HQLQuery = "FROM Message WHERE catagory.name = :catagory ORDER BY page ASC, seq ASC";
	...
	public void item(RestRequest request, RestResponse response) throws Exception {
		String HQLQuery = "FROM Message WHERE id = :id";
		Query query = entityManagerSvc.getInstance().createQuery(HQLQuery);
	...
	public void save(RestRequest request, RestResponse response) throws Exception {
		Message message = (Message) request.getParam("message");
		if (message == null){
			
		}
		entityManagerSvc.getInstance().merge(message);
	}
	
	public void delete(RestRequest request, RestResponse response) throws Exception {
		Message message = (Message) entityManagerSvc.getInstance().getReference(Message.class, new Long((Integer) request.getParam("id")));
		entityManagerSvc.getInstance().remove(message);
	}
}
