...
import org.toasthub.social.dao.NoteDao;

@RequestScoped
public class NoteSvc implements ServiceProcessor {
	...
	public void process(RestRequest request, RestResponse response) {
		...
		request.addParam("sysPageFormName", "SOCIAL_NOTE");
		request.addParam("sysPageLabelName", "SOCIAL_NOTE");
		request.addParam("sysPageTextName", "SOCIAL_NOTE");
	...
	public void itemCount(RestRequest request, RestResponse response) {
		try {
			noteDao.itemCount(request, response);
	...
	public void items(RestRequest request, RestResponse response) {
		try {
			noteDao.items(request, response);
			//utilSvc.addStatus(RestResponse.INFO, RestResponse.SUCCESS, "Save successful", response);
		} catch (Exception e) {
			utilSvc.addStatus(RestResponse.ERROR, RestResponse.ACTIONFAILED, "Save Failed", response);
			e.printStackTrace();
	...
	public void delete(RestRequest request, RestResponse response){
		try {
			noteDao.delete(request, response);
