...
import org.toasthub.core.general.dao.MenuDaoIface;
import org.toasthub.core.general.dao.MenuDaoQual;
...
@MenuSvcQual
@RequestScoped
public class MenuSvc implements ServiceProcessor, MenuSvcIface {

	@Inject @MenuDaoQual MenuDaoIface menuDao;
	@Inject 
