...
import org.toasthub.core.general.model.AppCachePageUtil;
import org.toasthub.core.general.model.AppPageOptionValue;
import org.toasthub.core.general.model.BaseEntity;
import org.toasthub.core.general.model.NewUserEvent;
...
@RequestScoped
public class UserManagerSvc implements ServiceProcessor, Serializable {
	protected static final String TAG = "UserManagerSvc";
	private static final long serialVersionUID = 1L;

	@Inject	UserManagerDao userManagerDao;
	@Inject	MailSvc mailSvc;
	@Inject Event<NewUserEvent> newUserEvent;
	...
	public void userAuthenticate(RestRequest request, RestResponse response) {
		if (!request.containsParam("appForms")) {
