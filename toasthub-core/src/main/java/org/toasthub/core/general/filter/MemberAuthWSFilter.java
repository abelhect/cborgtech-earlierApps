 ...
 */
public class MemberAuthWSFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		if (login.isLoggedIn()) {
			if (login.hasAccess("ROLE_MEMBER","PRM_MEMBER_AREA", "APP_CBORGCUST")){
			...
			// need to change this to a ajax reject response
