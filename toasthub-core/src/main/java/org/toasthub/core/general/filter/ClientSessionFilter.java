...
public class ClientSessionFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		SessionHolder.setURLDomain(httpRequest.getServerName());
		SessionHolder.setUserAgent(httpRequest.getHeader("User-Agent"));
		SessionHolder.setContextPath(httpRequest.getContextPath());
