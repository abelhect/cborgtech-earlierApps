...
import org.toasthub.core.general.dao.StatusDaoIface;
import org.toasthub.core.general.dao.StatusDaoQual;
...
@StatusSvcQual
@RequestScoped
public class StatusSvc implements ServiceProcessor, StatusSvcIface {

	@Inject @StatusDaoQual StatusDaoIface statusDao;
	...
	public void process(RestRequest request, RestResponse response) {
		...
		request.addParam("sysPageFormName", "MEMBER_STATUS");
		request.addParam("sysPageLabelName", "MEMBER_STATUS");
		request.addParam("sysPageTextName", "MEMBER_STATUS");
	...
	public void itemCount(RestRequest request, RestResponse response) {
		try {
			statusDao.itemCount(request, response);
		} catch (Exception e) {
	...
	public void items(RestRequest request, RestResponse response) {
		try {
			statusDao.items(request, response);
		} catch (Exception e) {
	...
	public void item(RestRequest request, RestResponse response) {
		try {
			statusDao.item(request, response);
		} catch (Exception e) {
