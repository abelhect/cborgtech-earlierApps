...
public class EntityManagerSvcLocal implements EntityManagerSvc {
	...
	@PersistenceContext(unitName = "toasthub2")
	protected EntityManager client2;
	...
	public EntityManager getInstance(){
		...
		if (cdomain.getAPPDomain().equals("toasthub2")){
			return client2;
		} else {
			return client1;
		}
